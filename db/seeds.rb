...
Review.create!({ body: "I've got some BEEF with whoever made this site!", rating: 2, reviewer_username: "MonstrCookie", reviewer_id: 3, product_id: 1 })
Review.create!({ body: "Now, now, let's settle this with proper cow-moo-nication!", rating: 4, reviewer_username: "StrawB3rries", reviewer_id: 2, product_id: 1 })
Review.create!({ body: "Okay, NOW you're making my blood boil! >:C", rating: 1, reviewer_username: "MonstrCookie", reviewer_id: 3, product_id: 1 })
Review.create!({ body: "Well, you're making my milk curdle *sigh*", rating: 5, reviewer_username: "StrawB3rries", reviewer_id: 2, product_id: 1 })
