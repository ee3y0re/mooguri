  ...
  return (
    <div className="checkout-null">
      <div className="checkout-title-and-main-redirect-empty">
        {!activeSession ? (
          <p className="checkout-null-div">Please login to start shopping.</p>
        ) : (
          <p className="checkout-null-header">Your cart is empty.</p>
        )}
      </div>
      <div className="checkout-null-flexbox">
        <Link to="/" id="checkout-null-link">
        ...
        <div className="checkout-carbo-message">
          ...
          <p>MOOguri offsets carbon emissions from just being a demo site.</p>
        </div>
      </div>
    </div>
  );
